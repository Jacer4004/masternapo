...
<div class="ventanas" id="personal_academicos" style=" text-align:justify !important">
...
&nbsp;&nbsp;&nbsp;
 <span id="titlosinternosper">Títulos Académicos: <?php echo $regpersacademia["tratamiento"]." ".$regpersacademia["nombres"]." ".$regpersacademia["apellidos"]?> </span> </h3>

<div id="titulos_academicos">

<?php include("mostrar_titulo.php"); ?>
