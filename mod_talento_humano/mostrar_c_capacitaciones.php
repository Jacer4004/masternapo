...
&nbsp;&nbsp;&nbsp;
 <span id="titlosinternosper">Capacitación: <?php echo $regpersacademia["tratamiento"]." ".$regpersacademia["nombres"]." ".$regpersacademia["apellidos"]?> </span> </h3>

<div id="titulos_academicos">

<?php include("mostrar_capacitaciones.php"); ?>
